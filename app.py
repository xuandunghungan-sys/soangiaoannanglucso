...
<div class="main-header">
    ...
    <p>Tác giả: Nghiêm Xuân Dũng - Trường  Tiểu học Hùng An - ĐT: 0912184585 </p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nghiêm Xuân Dũng - Trường tiểu học Hùng an- ĐT: 0912184585 </div>", unsafe_allow_html=True)
